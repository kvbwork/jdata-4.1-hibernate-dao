...
public class HibernateDaoApplicationTest {
    ...
    @Test
    void createOrUpdatePerson() throws Exception {
    ...
    @Test
    void getPersonByCity() throws Exception {
    ...
    @Test
    void getPersonByAgeLessThan() throws Exception {
    ...
    @Test
    void getPersonsByNameAndSurname() throws Exception {
    ...
    @Test
    void getFirstPersonsByNameAndSurname() throws Exception {
